...
* ^url = "https://fhir.dha.go.ke/terminology/ValueSet/eclaim-status-vs"
* ^status = #active
* ^experimental = false
...
* ^url = "https://fhir.dha.go.ke/terminology/ValueSet/eclaim-type-vs"
* ^status = #active
* ^experimental = false
...
* ^url = "https://fhir.dha.go.ke/terminology/ValueSet/eclaim-use-vs"
* ^status = #active
* ^experimental = false
...
* ^url = "https://fhir.dha.go.ke/terminology/ValueSet/eclaims-coverage-type-vs"
* ^status = #active
* ^experimental = false
...
* ^url = "https://fhir.dha.go.ke/terminology/ValueSet/referral-source-vs"
* ^status = #active
* ^experimental = false
