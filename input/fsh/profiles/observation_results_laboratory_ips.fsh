...
Alias: $Kenya-observation-results-uv-ips = http://example.org/StructureDefinition/Observation-results-uv-ips
...
Alias: $KenyaSpecimen-uv-ips = http://example.org/StructureDefinition/Kenya-specimen-ips
...
Profile: KenyaObservationResultsLaboratoryIps
Parent: $Kenya-observation-results-uv-ips
Id: Kenya-observation-results-laboratory-ips
...
* category only $KenyaCodeableConcept-uv-ips
...
* category[laboratory] only $KenyaCodeableConcept-uv-ips
...
* valueCodeableConcept only $KenyaCodeableConcept-uv-ips
...
* interpretation only $KenyaCodeableConcept-uv-ips
* specimen only Reference($KenyaSpecimen-uv-ips)
* hasMember only Reference(KenyaObservationResultsLaboratoryIps or $Kenya-observation-results-uv-ips)
* hasMember ^definition = "A reference to another Observation profiled by Kenya-observation-results-laboratory-ips. The target observation (for instance an individual test member of a panel) is considered as a sub-observation of the current one, which plays the role of a grouper."
