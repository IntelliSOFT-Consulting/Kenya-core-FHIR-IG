...
* identifier[providerLicense] MS
* identifier[providerLicense] ^short = "Licensing"
* identifier[providerLicense] ^patternIdentifier.system = $provider-license
...
* identifier[fid] ^patternIdentifier.type.coding.system = $facility-identifier-types
* identifier[fid] ^patternIdentifier.type.coding.code = #fid
...
* identifier[frCode] MS
* identifier[frCode] ^short = "Facility Registry Code"
* identifier[frCode] ^patternIdentifier.type.coding.system = $facility-identifier-types
* identifier[frCode] ^patternIdentifier.type.coding.code = #fr-code
...
* identifier[registrationNumber] MS
* identifier[registrationNumber] ^short = "Facility registration number"
* identifier[registrationNumber] ^patternIdentifier.type.coding.system = $facility-identifier-types
* identifier[registrationNumber] ^patternIdentifier.type.coding.code = #registration-number
